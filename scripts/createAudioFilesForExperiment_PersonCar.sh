...
DictionaryFileList=('dictionaryFile_CarPerson_10.yml' 'dictionaryFile_CarPerson_20.yml' 'dictionaryFile_CarPerson_50.yml' 'dictionaryFile_CarPerson_100.yml')
let DictionaryFileCount=${#DictionaryFileList[@]}

DictionaryFileDirList=('10' '20' '50' '100')
